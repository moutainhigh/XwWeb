	...
	<script type="text/javascript">
		...
		function getSex(){
			...
			//获取生日
				...
				document.getElementsByName("birthDay")[0].value = d;
		}
		...
		function getGradeDate(){
		    fPopUpCalendarDlg();
		   // var gradeDate = $("[name='gradeDate']").val();
		    //fPopUpCalendarDlg();
		   // alert(gradeDate+"===="+gradeDate.replace(/-/ig,"") );
		  	 // $("[name='gradeDate']").val(gradeDate.replace(/-/ig,""));
			...
			<div class="right_w">
				<div class="from_bg">
					<div class="right_v">
		                ...
		                <s:if test="backSts==1">
		                     <input type="button" value="返回" onclick="javascript:window.location='CifPersInfAction_findByPage.action'" class="button_form"/>
						</s:if>
						</div>
					</div>
				</div>
