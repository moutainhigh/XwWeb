			...
			<div>
				...
				<div>
					<div  class="tabs-container" />
						<s:form name="operform" action="AcDamFormulaAction_insert.action" method="post" theme="simple" validate="true">
							<table  align="center" width=1200  >
								...
								<tr>
									...
									<td align="left" width="30%" ><s:textfield alt="费率编号" property="frId"  maxlength="10"  readonly="true"
											name="frId"/>
