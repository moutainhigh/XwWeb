			...
			<div>
				...
				<div>
					<div  class="tabs-container" />
						<s:form name="operform" action="AcFeeFormulaAction_update.action" method="post" theme="simple" validate="true">
							<table  align="center" width=1200  >
								...
								<tr>
									...
									<td align="left" width="30%" ><s:textfield alt="费率定义编号" property="frId"  maxlength="10"
											name="frId"  readonly="true"/>
								...
								<tr>
									...
									<td align="left" colspan="3">
										<s:textarea alt="费用公式" property="feeFormula"  readonly="true" maxlength="500"
							...
							<!--	<dhcc:button typeclass="btn_80" value="返回" action="返回"
									...
									<input type="button" name="back" value="返回" onClick="javascript:window.location='AcFeeFormulaAction_findByPage.action'" class="button_form" />
							</div>
								</s:form>
							</div>
						</div>
