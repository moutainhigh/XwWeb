			...
			<div>
				...
				<div>
					<div  class="tabs-container" />
						<s:form name="operform" action="AcReplanFormulaAction_update.action" method="post" theme="simple" validate="true">
							<table  align="center" width=1200  >
								<tr>
									...
									<td align="left" width="30%"><s:textfield alt="还款计划名称" property="formulaName"  maxlength="50"
											name="formulaName" />
									</td>
								</tr>
								<tr></tr>
