...
<script> 
	...
	<s:form method="post" theme="simple" name="cms_form"
		action="ProjAcctActionUpdateForZ.action" param="projNo=projNo@flag=flag" >
		<div class="right_bg">
			<div class="right_w">
				<div class="from_bg">
					<div class="right_v">
					<s:if test="query=='query'">
						<dhcc:formTag property="formproj0017" mode="query" />
					</s:if>
					<s:else>
						<dhcc:formTag property="formproj0020" mode="query" />
					</s:else>
						<div class="from_btn">
						<s:if test="query!='query'">
