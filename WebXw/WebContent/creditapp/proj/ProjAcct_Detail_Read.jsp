				...
				<div class="from_bg">
					...
					<s:else>
						...
						<s:if test="query!='query'">
							...
							<s:if test="backSts!=1"><!--
						      <input type="button" value="返回" onclick="javascript:window.location='ProjAcctAction_findByPageToProj_Read.action'" class="button_form"/>
						   --></s:if>
						</div>
					</div>
				</div>
