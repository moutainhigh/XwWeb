...
<script> 
	...
	$(document).ready(function(){
		init();
		var acctType = document.getElementsByName("acctType")[0].value; 
	...
	<s:form method="post" theme="simple" name="cms_form"
		action="ProjAcctActionUpdate.action" param="projNo=projNo@flag=flag" >
		<div class="right_bg">
			<div class="right_w">
				<div class="from_bg">
					<div class="right_v">
					<s:if test="query=='query'">
						<dhcc:formTag property="formproj0016" mode="query" />
					</s:if>
					<s:else>
