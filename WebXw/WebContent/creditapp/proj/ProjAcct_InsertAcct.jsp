	...
	<s:form method="post" theme="simple" name="cms_form"
		...
		<div class="right_bg">
			<div class="right_w">
				<div class="from_bg">
					<div class="right_v">
						<dhcc:formTag property="formproj0028" mode="query" />
						<div class="from_btn">
							...
							<dhcc:button typeclass="button_form" value="返回" action="返回" onclick="ProjAcctAction_findByPageToProj_Read.action" param="projNo=projNo"></dhcc:button>
						     ...
						     <s:else>
						      <dhcc:button typeclass="button_form" value="返回" action="返回" onclick="ProjAcctAction_findByPage.action" param="projNo=projNo@flag=flag"></dhcc:button>
						     </s:else>
						</div>
					</div>
				</div>
