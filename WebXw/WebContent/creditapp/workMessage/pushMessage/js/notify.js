...
//		var closeHeight = $(this).height()
	...
	$.notify = function(options) {
		...
		msgHtml += "</div>";
*/
		msgHtml += "<div class='tipswin' id=\"" + idNotify + idx + "\">";
		msgHtml += "<div class='tipswintit'><span>" + options.title + "</span><a class='tipsclose'></a></div>";
		msgHtml += "<div class='tipswincon'>";
		msgHtml += "<i></i>";
		//msgHtml += "<img src='" + _img + "'/>";
		msgHtml += "<p>" + options.content + "</p>";
		//msgHtml += "<a class='tipsmore'>查看</a>";
		msgHtml += "</div>";
		msgHtml += "</div>";
