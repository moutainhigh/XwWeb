				...
				<div class="from_bg">
					<div class="right_v">
						<table width="100%" align="center" class="searchstyle">
							...
							<tr>
								<td>
									<font color=red size="3px">&nbsp&nbsp【&nbsp提示：&nbsp&nbsp请输入合作机构号进行查询&nbsp!&nbsp】</font>
								</td>
							</tr>
						</table>
						<div class="tools_372">
							<dhcc:button value="查询" action="查询" commit="true" onclick="chkBrNo();"
		...
		<div class="right_bg">
			<div class="right_w">
				<div class="from_bg">
					<div class="right_v">
						<div class="tabCont">
							<div class="tabTitle">进件失败业务列表</div>
