...
<html>
	...
	<s:form method="post" theme="simple" name="cms_form"
		action="LnApprIdeaAction_findByPage.action">
		<div class="right_bg">
			<div class="right_w">
				<div class="from_bg">
					<div class="right_v">
						<table width="100%" align="center" class="searchstyle">
							<tr>
								<td>
									<dhcc:formTag property="formlnappridea0001" mode="query" />
								</td>
							</tr>
						</table>
						<div class="tools_372">
			...
			<div class="right_w">
				<div class="from_bg">
					<div class="right_v">
						...
						<dhcc:tableTag paginate="lnApprIdeaList" property="tablelnappridea0001"
									head="true" />
					</div>
				</div>
			</div>
