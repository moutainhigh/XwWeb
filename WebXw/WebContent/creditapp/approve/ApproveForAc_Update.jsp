		...
		<div class="right_w">
			...
			<div class="right_v">
				<s:form name="operform"
					action="ApproveAcAction_doSubmit.action" method="post"
					theme="simple">
					<dhcc:formTag property="formapprove5005" mode="query" />
					...
					<div class="from_btn">
						...
						<dhcc:button typeclass="button3" commit="true" value="提交" action="提交"></dhcc:button>
								<dhcc:button typeclass="button_form" value="返回" action="返回" onclick="ApproveAcAction_findByPage.action"></dhcc:button>
					-->
					</div>
				</s:form>
			</div>
