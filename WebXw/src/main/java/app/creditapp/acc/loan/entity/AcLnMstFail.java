...
* @version：1.0
**/
public class AcLnMstFail extends BaseDomain {
	...
	private String projName;//合作机构名称
	private String prdtName;//合作机构名称
