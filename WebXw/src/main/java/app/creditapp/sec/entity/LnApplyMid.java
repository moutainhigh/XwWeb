...
//	private List<WsLnAcctMid>  acctMidList;  //  进件账户信息
//	private List<WsLnGageMid>  gageMidList;  //  预进件押品信息
	...
	/**
	 * @return 筛查结果[01成功02黑名单客户03评级拒绝04借款人原因05其他原因]
	 */
	public String getChkRes() {
	 	return chkRes;
	}
	/**
	 * @设置 筛查结果[01成功02黑名单客户03评级拒绝04借款人原因05其他原因]
	 * @param chkRes
	 */
...
//	public List<WsLnAcctMid> getAcctMidList() {
//		return acctMidList;
//	}
//	public void setAcctMidList(List<WsLnAcctMid> acctMidList) {
//		this.acctMidList = acctMidList;
//	}
//	public List<WsLnGageMid> getGageMidList() {
//		return gageMidList;
//	}
//	public void setGageMidList(List<WsLnGageMid> gageMidList) {
