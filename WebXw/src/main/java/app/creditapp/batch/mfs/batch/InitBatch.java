 ...
 *
 */
public class InitBatch extends JavaBatch{

	public InitBatch(String batchDate) {
		super(batchDate);
	}
	...
	public void doBatch(BatchNode batchNode) throws Exception {
		...
		try {
			//更新系统状态为批量中
			String sql = "UPDATE SYS_GLOBAL SET SYS_STS = '02',BAT_DATE=SYS_DATE WHERE GLO_NO = '0000000000'";
			this.updateWithLog("批量初始化",sql, null);
