...
* @version：1.0
**/
public class PreApply extends BaseDomain {
	private String appDate;//进件日期
	private String prePactNo;//合同编号
	private String brNo;//合作机构号码
	private String batchNo;//批次号码
	private String appId;//申请ID
	private String appSts;//申请状态[01未处理02通过03拒绝]
	...
	private String projName;//信托项目名称
	private String cifAreaName;//户籍归属名称
	private String appAreaName;//申请地点
	//数据库不含次字段，使用fun_getprdtname(PRDT_NO)获得
	...
	/**
	 * @return 申请状态[01未处理02通过03拒绝]
	 */
	public String getAppSts() {
	 	return appSts;
	}
	/**
	 * @设置 申请状态[01未处理02通过03拒绝]
	 * @param appSts
	 */
