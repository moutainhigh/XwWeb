 ...
 * @作者 DHCC-SONG
 * @日期 Jun 23, 2016
 * @描述 预进件信息实体类   pre_apply
 */
public class WsIn2004 {
	...
	// List<Gage>
	private List<WsIn2004_1> listGage;
	
	public List<WsIn2004_1> getListGage() {
		return listGage;
	}
	public void setListGage(List<WsIn2004_1> listGage) {
