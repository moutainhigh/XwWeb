...
/**
 * @作者 DHCC-LIU
 * @日期 Jun 23, 2016 list List
 * @描述 进件信息查询---输出实体类
 */
public class WsOut2104_1 {
	...
	private double  VouAmt;// 期缴（保）费金额
	...
	private List<WsOut2104_1_1> listAc;// listAc 账户信息
	private List<WsOut2104_1_2> listGage;// listGage 押品信息
	private List<WsOut2104_1_3> listCom;// listCom 共同借款人
	private List<WsOut2104_1_4> listRel;// listRel 借款关联人
	...
	public List<WsOut2104_1_1> getListAc() {
		return listAc;
	}
	public void setListAc(List<WsOut2104_1_1> listAc) {
		this.listAc = listAc;
	}
	public List<WsOut2104_1_2> getListGage() {
		return listGage;
	}
	public void setListGage(List<WsOut2104_1_2> listGage) {
		this.listGage = listGage;
	}
	public List<WsOut2104_1_3> getListCom() {
		return listCom;
	}
	public void setListCom(List<WsOut2104_1_3> listCom) {
		this.listCom = listCom;
	}
	public List<WsOut2104_1_4> getListRel() {
		return listRel;
	}
	public void setListRel(List<WsOut2104_1_4> listRel) {
