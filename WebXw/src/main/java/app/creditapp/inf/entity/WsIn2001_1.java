 ...
 * @作者 DHCC-LIU
 * @日期 Jun 23, 2016
 * @描述 预审批批量申请[2001] List List<WsPreApply>
 */
public class WsIn2001_1 {
	private String appId; // 申请ID
	private String appDate; // 申请ID
	...
	private String dealSts = "00";//处理状态
	private String dealDesc = "未处理";//处理结果
	...
	private List<WsIn2001_1_1> listGage;//list<gage>
	...
	public List<WsIn2001_1_1> getListGage() {
		return listGage;
	}

	public void setListGage(List<WsIn2001_1_1> listGage) {
